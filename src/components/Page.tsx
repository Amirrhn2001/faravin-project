              ...
              <>
                {ayat[page][i] === 1 &&
                  <div className='overflow-hidden flex flex-col box-border m-4 p-4 justify-center items-center gap-2 bg-pacificBlue z-10 text-white rounded-md shadow-pacificBlue'>
                    {surah[page][i] !== 1 && surah[page][i] !== 9 && <div>بِسۡمِ اللّٰهِ الرَّحۡمٰنِ الرَّحٖیمِ</div>}
                    <div>
                      <span>{surahName[surah[page][i]-1][0]}</span>
                    </div>
                  </div>
                }
                <div 
                  key={i} 
                  className={`overflow-clip m-4 rounded bg-babyPowder shadow box-border p-4`} 
                  >
                  <div className='flex'>
                    ...
                    <div className='w-12 h-12 z-20 font-bold font-sans flex justify-center items-center cursor-pointer' onClick={() => navigator.clipboard.writeText(aye)}>
                      <ImCopy />
                    </div>
                  </div>
                  <div 
